...
<head>
    ...
    <title>Bill-Payment-{{ $register->reg_student }}-{{ $register->project_alias }}</title>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="72%" style="vertical-align:top;">
                    <span style="font-weight:bold;">สมัครเข้าศึกษาต่อระดับปริญญาตรี {{ $register->name_full }}
                        ปีการศึกษา {{ $register->reg_year }} </span><br />
                ...
                @if ($register->reg_project == 8)
                    <td width="18%" style="text-align:center;vertical-align:top;">300</td>
                @else
            ...
            <tr style="background-color:#d3d3d3;">
                @if ($register->reg_project == 8)
                    <td colspan="2" style="text-align:center;font-weight:bold;">สามร้อยบาทถ้วน</td>
                    <td style="text-align:center;font-weight:bold;">300.00</td>
                @else
                    <td colspan="2" style="text-align:center;font-weight:bold;">สองร้อยบาทถ้วน</td>
                    <td style="text-align:center;font-weight:bold;">200.00</td>
                @endif
            ...
            <tr>
                <td colspan="2"
                    ...
                    กำหนดชำระเงินภายในวันที่ {{ DateThaiFull($plan->pay_open) }} -
                    {{ DateThaiFull($plan->pay_close) }}
                    <br /><br /><br />
    ...
    <table width="100%">
        <tr>
            ...
            <td width="45%" style="font-weight:bold;border-right: 0.5px solid gray;font-size:12pt;">
                กำหนดชำระเงินภายในวันที่ {{ DateThaiFull($plan->pay_open) }} - {{ DateThaiFull($plan->pay_close) }}
            </td>
        </tr>
        <tr>
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                @if ($register->reg_project == 8)
                    <td width="25%" style="text-align:center;padding: 0.1rem 0.1rem !important;">300.00</td>
                @else
                    <td width="25%" style="text-align:center;padding: 0.1rem 0.1rem !important;">200.00</td>
                @endif
            </tr>
            <tr>
                <td width="25%" style="text-align:center;font-size:11pt;padding: 0.1rem 0.1rem !important;">
                    จำนวนเงินที่เป็นตัวอักษร</td>
                @if ($register->reg_project == 8)
                    <td width="25%" colspan="3"
                        style="text-align:center;font-size:12pt;padding: 0.1rem 0.1rem !important;">สามร้อยบาทถ้วน</td>
                @else
                    <td width="25%" colspan="3"
                        style="text-align:center;font-size:12pt;padding: 0.1rem 0.1rem !important;">สองร้อยบาทถ้วน</td>
                @endif
            </tr>
        </tbody>
    </table>
            ...
            <td width="40%" style="text-align:left;">
                @if ($register->reg_project == 8)
                    <img style="padding:7px;border:0.5px solid #021a40;background-color:#fff;" width="80px"
                        height="80px" src="data:image/png;base64,  {!! DNS2D::getBarcodePNG(
                            '|099400040150770 ' . $register->reg_code . ' ' . $register->reg_student . ' 30000',
                            'QRCODE',
                        ) !!}">
                @else
                    <img style="padding:7px;border:0.5px solid #021a40;background-color:#fff;" width="80px"
                        height="80px" src="data:image/png;base64,  {!! DNS2D::getBarcodePNG(
                            '|099400040150770 ' . $register->reg_code . ' ' . $register->reg_student . ' 20000',
                            'QRCODE',
                        ) !!}">
                @endif
            </td>
            <td width="60%" style="text-align:center;">
                @if ($register->reg_project == 8)
                    <img width="450px" height="40px"
                        src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode('|099400040150770' . "\n" . $register->reg_code . "\n" . $register->reg_student . '30000', $generatorPNG::TYPE_CODE_128)) }}">
                    <br />
                    |<span style="font-size: 11pt;">I099400040150770 {{ $register->reg_code }}
                        {{ $register->reg_student }} 30000</span>
                @else
                    <img width="450px" height="40px"
                        src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode('|099400040150770' . "\n" . $register->reg_code . "\n" . $register->reg_student . '20000', $generatorPNG::TYPE_CODE_128)) }}">
                    <br />
                    |<span style="font-size: 11pt;">I099400040150770 {{ $register->reg_code }}
                        {{ $register->reg_student }} 20000</span>
                @endif
            </td>
        </tr>
    </table>
