            ...
            <td width="40%" style="text-align:left;">
                @if ($register->reg_project == 8)
                    <img style="padding:7px;border:0.5px solid #021a40;background-color:#fff;" width="80px"
                        height="80px" src="data:image/png;base64, {!! nl2br(base64_encode($qrCode300)) !!}">
                @else
                    <img style="padding:7px;border:0.5px solid #021a40;background-color:#fff;" width="80px"
                        height="80px" src="data:image/png;base64,{!! nl2br(base64_encode($qrCode200)) !!}" alt="QR Code">
                @endif
